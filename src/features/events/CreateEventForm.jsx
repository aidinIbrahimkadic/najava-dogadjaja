...
//       user_idguid: eventToEdit.user.idguid,
//       cijena: eventToEdit.cijena ? parseFloat(eventToEdit.cijena).toFixed(2) : '0.00',
//       // Ako vec ima termine u bazi (ako ne, fallback je prazan niz)
...
//             termini: [], // inicijalno prazan niz; za single-case koristimo start_date
//           },
//     }
//   );
...
//     // Ako nema end_date, automatski ga izračunaj iz start_date (postojeće ponašanje)
//     if (!end_date && start_date) {
//       const newEnd = dayjs(start_date).add(DEFAULT_EVENT_DURATION_IN_HOURS, 'hour');
//       data.end_date = newEnd.format('YYYY-MM-DDTHH:mm');
//     }

//     // Priprema više termina
//     // Ako je uključeno više termina, uzmi ih iz fieldArray;
//     // u svakom slučaju po zahtjevu end_datetime = start_datetime.
//     // Ako NIJE uključeno, napravi jedan termin iz start_date.
//     const preparedTermini = ima_vise_termina
//       ? (data.termini || [])
//           .filter((t) => t?.start_datetime) // izbaciti prazne
//           .map((t) => ({
//             start_date: t.start_datetime,
//             end_date: t.start_datetime, // po zahtjevu
//           }))
//       : start_date
//         ? [
//             {
//               start_date: start_date,
//               end_date: start_date, // po zahtjevu
//             },
//           ]
//         : [];

//     data.ima_vise_termina = !!ima_vise_termina;
//     data.termini = preparedTermini;
...
//                               field.onChange(v);
//                               // end_datetime = start_datetime (po zahtjevu)
//                               setValue(`termini.${index}.end_datetime`, v);
//                             }}
//                             disabled={isWorking}
//                           />
//                         )}
...
//                         append({
//                           start_datetime: '',
//                           end_datetime: '', // bit će izjednačeno automatski
//                         })
//                       }
//                       disabled={isWorking}
//                     >
...
function CreateEventForm({ eventToEdit = {}, onCloseModal }) {
  ...
  function onSubmit(data) {
    ...
    // ⬇️ KLJUČNO: hook kod tebe očito šalje FormData, pa ovdje pretvaramo
    // u stringove da ne završi kao "[object Object]".
    ...
    // (opcionalno) Ako backend očekuje baš 'institucija_idguid', pazi da ne bude 'institucijaIdguid'
    // Ovaj form koristi 'institucija_idguid' svuda.
    // Ako vidiš u Network tabu camelCase, to dolazi iz hooka—provjeri mapiranje u usePostEvent.
